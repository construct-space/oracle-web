 ...
 *
 * @deprecated Use `SelectMenu` instead. `Select` is kept as a shim for workspace
 *   consumers that still import it; prefer `SelectMenu` for new code — it supports
 *   searchable, grouped options, icons, and richer keyboard nav. This file will be
