...
const colorVariantClasses = computed(() => {
  ...
  if (v === 'ghost') {
    ...
    if (c === 'primary')
      return 'bg-transparent text-[var(--app-accent)] hover:bg-[color-mix(in_srgb,var(--app-accent)_10%,transparent)]'
  ...
  if (v === 'soft') {
    if (c === 'primary')
      return 'bg-[color-mix(in_srgb,var(--app-accent)_15%,transparent)] text-[var(--app-accent)] hover:bg-[color-mix(in_srgb,var(--app-accent)_25%,transparent)]'
    if (c === 'neutral')
      return 'bg-[color-mix(in_srgb,var(--app-muted)_15%,transparent)] text-[var(--app-foreground)] hover:bg-[color-mix(in_srgb,var(--app-muted)_25%,transparent)]'
    ...
    return 'bg-[color-mix(in_srgb,var(--app-accent)_15%,transparent)] text-[var(--app-accent)]'
  }
  // Outline variant
  if (v === 'outline') {
  ...
  // Link variant
  if (v === 'link') {
    return 'bg-transparent text-[var(--app-accent)] hover:underline p-0!'
  }
  // Solid (default)
  if (c === 'neutral')
    return 'bg-[var(--app-foreground)]/10 text-[var(--app-foreground)] hover:bg-[var(--app-foreground)]/20'
  if (c === 'warning') return 'bg-amber-500 text-white hover:bg-amber-600'
  if (c === 'error') return 'bg-red-500 text-white hover:bg-red-600'
  return 'bg-[var(--app-accent)] text-[var(--app-accent-foreground,white)] hover:opacity-90'
})
</script>
