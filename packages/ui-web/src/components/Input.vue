 ...
 *
 * Extra HTML attributes (autocomplete, inputmode, pattern, maxlength,
 * name, id, readonly, aria-*…) are forwarded to the inner <input>.
 * Without this, browsers warn about password inputs missing autocomplete
 * and password managers can't associate fields to the form.
 */
